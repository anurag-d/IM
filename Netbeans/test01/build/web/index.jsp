<%-- 
    Document   : index
    Created on : Jan 7, 2018, 4:33:56 PM
    Author     : anurag
--%>
    ...
    <body>
        <nav class="navbar navbar-default navbar-header header">
            <a class="navbar-brand" href="#">
                ...
                <img src="img/logo/favicon1.png" class="hidden-xs" alt=""  />
            </a>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="#lobipanel">
                                    <span class="inner-text">User Groups</span>
                                </a>
                            </li>
                            <li>
                                <a href="#lobibox">
                                    <span class="inner-text">Users</span>
                                </a>
                            </li>
                            <li>
                                <a href="#lobitab">
                                    <span class="inner-text">Informatica Setup</span>
                                </a>
                            </li>
                            <li>
                                <a href="#lobilist">
                                    <span class="inner-text">Email Groups</span>
                                </a>
                            </li>
                            <li>
                                <a href="#lobilist">
                                    <span class="inner-text">Email Lists</span>
                                </a>
                            </li>
                        </ul>
                    </li>
